...
export type PersonsQuery = ({ __typename?: 'Query' } & { me: Maybe<({ __typename?: 'User' } & Pick<User, 'email'> & { profile: Maybe<({ __typename?: 'Profile' } & Pick<Profile, 'fullName' | 'notifications'>)> })> });
...
`;
export type PersonsComponentProps = Omit<ReactApollo.QueryProps<PersonsQuery, PersonsQueryVariables>, 'query'>;

export const PersonsComponent = (props: PersonsComponentProps) => (
    <ReactApollo.Query<PersonsQuery, PersonsQueryVariables> query={PersonsDocument} {...props} />
);

export type PersonsProps<TChildProps = {}> =
    Partial<ReactApollo.DataProps<PersonsQuery, PersonsQueryVariables>>
    & TChildProps;

export function withPersons<TProps, TChildProps = {}>(operationOptions?: ReactApollo.OperationOption<TProps,
    PersonsQuery,
    PersonsQueryVariables,
    PersonsProps<TChildProps>>) {
    return ReactApollo.withQuery<TProps, PersonsQuery, PersonsQueryVariables, PersonsProps<TChildProps>>(PersonsDocument, {
        alias: 'withPersons',
        ...operationOptions
    });
};